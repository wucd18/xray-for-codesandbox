...
UUID=${UUID:-'5b072fd9-59ed-4cd9-9900-cb5e3e2ea760'}
...
vmlink=vmess://$(echo -n "{\"v\":\"2\",\"ps\":\"codesandbox_vmess\",\"add\":\"$URL\",\"port\":\"443\",\"id\":\"$UUID\",\"aid\":\"0\",\"net\":\"ws\",\"type\":\"none\",\"host\":\"$URL\",\"path\":\"$VMESS_WSPATH?ed2048\",\"tls\":\"tls\"}" | base64 -w 0)
vllink="vless://"$UUID"@"$URL":443?encryption=none&security=tls&type=ws&host="$URL"&path="$VLESS_WSPATH"?ed2048#codesandbox_vless"
